window.addEventListener('load', () => {
    ...
    Swal.fire({
        title: 'Apakah sayang mau menyaksikanya sambil mendengarkan musik?',
        icon: 'warning',
...
document.getElementById('verificationName').addEventListener('submit', function(e) {
    ...
    // Validasi nama
    const validNames = ['aynaa','anya', 'Anya', 'rr anya shavella teryana', 'Rr Anya Shavella Teryana', 'oioi'];
